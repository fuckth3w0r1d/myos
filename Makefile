...
# ===== 参数 =====
LIB = -I lib/ -I kernel/ -I device/ -I thread/ -I userprog/ -I fs/
...
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/print.o $(BUILD_DIR)/kernel.o $(BUILD_DIR)/interrupt.o $(BUILD_DIR)/init.o \
	...
	$(BUILD_DIR)/syscall.o $(BUILD_DIR)/syscall-init.o $(BUILD_DIR)/stdio.o $(BUILD_DIR)/kstdio.o $(BUILD_DIR)/ide.o \
...
$(BUILD_DIR)/kstdio.o: lib/kernel/kstdio.c
	$(CC) $(CFLAGS) $< -o $@
